...
/* ============================ ASPIRAPOLVERE SENZA FILO (nuova, 14 set) ============================ */
{
  ...
  facets: [
    ...
    { id: 'peso', question: 'Quanto conta il peso in mano?', seoIntent: 'aspirapolvere senza filo leggero',
      options: [
        { id: 'molto', label: 'Molto: la uso anche su scale, divani, in alto', slug: 'leggeri', seoTitle: 'Migliori aspirapolvere senza filo leggeri', reason: 'peso contenuto', must: p => p.attrs.weight <= 3, score: p => (p.attrs.weight <= 1.8 ? 3 : p.attrs.weight <= 2.5 ? 1 : 0) },
...
/* ============================ PURIFICATORI D'ARIA (nuova, 15 set) ============================ */
{
  ...
  facets: [
    ...
    { id: 'notte', question: 'Lo terrai acceso in camera mentre dormi?', seoIntent: 'purificatore d\'aria silenzioso per camera da letto',
      options: [
        { id: 'si', label: 'Sì, deve essere silenzioso', slug: 'silenziosi-per-camera-da-letto', seoTitle: 'Migliori purificatori d\'aria silenziosi per camera da letto', reason: 'uso notturno', must: p => p.attrs.noise <= 30, score: p => (p.attrs.nightMode === true ? 2 : 0) },
